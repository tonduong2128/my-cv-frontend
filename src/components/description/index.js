...
function Description(props) {
    ...
    return (
        <div className="description">
            <div className="container-title" onDoubleClick={handleDoubleClickTitle}>
                {isEditTit ? (
                    <textarea
                        value={title}
            ...
            <div className="description-content" onDoubleClick={handleDoubleClickDesc}>
                {isEditDes ? (
                    <textarea
                        type="text"
                        value={desText}
                    ...
                    descriptions.map((des, index) => {
                        ...
                        return (
                            <React.Fragment key={index}>
                                <div className={props.isBold ? 'content-item sub-title' : 'content-item '}>{title}</div>
